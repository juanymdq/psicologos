...
<html lang="en">
    <head>
        ...
        <script>
          /*  if(!location.hash.replace('#', '').length) {
                ...
                var token = '#' + (Math.random() * 100).toString().replace('.', '');
                location.href = location.href.split('#')[0] + token;
                location.reload();
                console.log(token);                
                var id = <?=$call?>;
                var obj = {'id': id, 'token':token}
                var url = "<?=base_url('turnos/actualizaToken')?>";
    ...
    <body>
    <div class="cabecera">
        <p>Videollamada desde Terapiavirtual.online</p>
    </div>
        <article>
            ...
            <section class="experiment">
                ...
                ?>
                    ...
                    <input type="hidden" id="id_turno" value="<?=$call?>">
                    <input type="text" id="conference-name" value="Lic. <?=$this->session->userdata('pr_apellido').', '.$this->session->userdata('pr_nombre')?>" style="width: 50%;">
                    <button id="setup-new-room" class="setup">Iniciar videollamada</button>
                   
                <?php }else{?>
                    <p>Debera espera a que el profesional inicie la videollamada</p>
                 <?php   }?>
                </section>
            ...
            <script>
                ...
                var config = {
                    ...
                    onRoomFound: function(room) {                        
                        ...
                        tr.innerHTML = '<td><strong>' + room.roomName + '</strong> quiere compartir la conferencia con usted!!</td>' +
