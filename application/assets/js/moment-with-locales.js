;(function (global, factory) {
    ...
    hooks.defineLocale('az', {
        ...
        weekdays: 'Bazar_Bazar ert?si_Ç?rs?nb? axsami_Ç?rs?nb?_Cüm? axsami_Cüm?_S?nb?'.split(
            '_'
        ),
        ...
        dayOfMonthOrdinalParse: /\d{1,2}-(inci|inci|nci|üncü|nci|uncu)/,
        ordinal: function (number) {
            if (number === 0) {
    ...
    hooks.defineLocale('bs', {
        ...
        monthsParseExact: true,
        weekdays: 'nedjelja_ponedjeljak_utorak_srijeda_cetvrtak_petak_subota'.split(
            '_'
        ),
    ...
    var months$4 = 'leden_únor_brezen_duben_kveten_cerven_cervenec_srpen_zárí_ríjen_listopad_prosinec'.split(
            '_'
        ),
        monthsShort = 'led_úno_bre_dub_kve_cvn_cvc_srp_zár_ríj_lis_pro'.split('_'),
        monthsParse$1 = [
            /^led/i,
            /^úno/i,
            /^bre/i,
        ...
        // NOTE: 'cerven' is substring of 'cervenec'; therefore 'cervenec' must precede 'cerven' in the regex to be fully matched.
        // Otherwise parser matches '1. cervenec' as '1. cerven' + 'ec'.
        monthsRegex$2 = /^(leden|únor|brezen|duben|kveten|cervenec|cervence|cerven|cervna|srpen|zárí|ríjen|listopad|prosinec|led|úno|bre|dub|kve|cvn|cvc|srp|zár|ríj|lis|pro)/i;
    ...
    function translate$1(number, withoutSuffix, key, isFuture) {
        ...
        switch (key) {
            ...
            case 'MM': // 9 months / in 9 months / 9 months ago
                if (withoutSuffix || isFuture) {
                    return result + (plural$1(number) ? 'mesíce' : 'mesícu');
                } else {
    ...
    hooks.defineLocale('cs', {
        ...
        // NOTE: 'cerven' is substring of 'cervenec'; therefore 'cervenec' must precede 'cerven' in the regex to be fully matched.
        // Otherwise parser matches '1. cervenec' as '1. cerven' + 'ec'.
        monthsStrictRegex: /^(leden|ledna|února|únor|brezen|brezna|duben|dubna|kveten|kvetna|cervenec|cervence|cerven|cervna|srpen|srpna|zárí|ríjen|ríjna|listopadu|listopad|prosinec|prosince)/i,
        monthsShortStrictRegex: /^(led|úno|bre|dub|kve|cvn|cvc|srp|zár|ríj|lis|pro)/i,
    ...
    hooks.defineLocale('el', {
        monthsNominativeEl: '?a????????_Feß????????_???t???_?p??????_?????_???????_???????_?????st??_Sept?µß????_??t?ß????_???µß????_?e??µß????'.split(
            '_'
        ),
        monthsGenitiveEl: '?a???a????_Feß???a????_?a?t???_?p??????_?a???_???????_???????_?????st??_Septeµß????_??t?ß????_??eµß????_?e?eµß????'.split(
            '_'
        ),
        ...
        weekdays: '????a??_?e?t??a_???t?_?et??t?_??µpt?_?a?as?e??_S?ßßat?'.split(
            '_'
        ),
    ...
    hooks.defineLocale('eo', {
        months: 'januaro_februaro_marto_aprilo_majo_junio_julio_augusto_septembro_oktobro_novembro_decembro'.split(
            '_'
        ),
        monthsShort: 'jan_feb_mart_apr_maj_jun_jul_aug_sept_okt_nov_dec'.split('_'),
        ...
        relativeTime: {
            ...
            h: 'unu horo',
            hh: '%d horoj',
            d: 'unu tago', //ne 'diurno', car estas uzita por proksimumo
            dd: '%d tagoj',
            M: 'unu monato',
            MM: '%d monatoj',
            y: 'unu jaro',
    ...
    hooks.defineLocale('hr', {
        months: {
            format: 'sijecnja_veljace_ožujka_travnja_svibnja_lipnja_srpnja_kolovoza_rujna_listopada_studenoga_prosinca'.split(
                '_'
            ),
            standalone: 'sijecanj_veljaca_ožujak_travanj_svibanj_lipanj_srpanj_kolovoz_rujan_listopad_studeni_prosinac'.split(
                '_'
            ),
        },
    ...
    hooks.defineLocale('lt', {
        months: {
            format: 'sausio_vasario_kovo_balandžio_gegužes_birželio_liepos_rugpjucio_rugsejo_spalio_lapkricio_gruodžio'.split(
                '_'
            ),
            standalone: 'sausis_vasaris_kovas_balandis_geguže_birželis_liepa_rugpjutis_rugsejis_spalis_lapkritis_gruodis'.split(
                '_'
            ),
        ...
        weekdays: {
            format: 'sekmadieni_pirmadieni_antradieni_treciadieni_ketvirtadieni_penktadieni_šeštadieni'.split(
                '_'
            ),
            standalone: 'sekmadienis_pirmadienis_antradienis_treciadienis_ketvirtadienis_penktadienis_šeštadienis'.split(
                '_'
            ),
            isFormat: /dddd HH:mm/,
        },
    ...
    var units$1 = {
        ss: 'sekundes_sekundem_sekunde_sekundes'.split('_'),
    ...
    hooks.defineLocale('lv', {
        months: 'janvaris_februaris_marts_aprilis_maijs_junijs_julijs_augusts_septembris_oktobris_novembris_decembris'.split(
            '_'
        ),
        monthsShort: 'jan_feb_mar_apr_mai_jun_jul_aug_sep_okt_nov_dec'.split('_'),
        weekdays: 'svetdiena_pirmdiena_otrdiena_trešdiena_ceturtdiena_piektdiena_sestdiena'.split(
            '_'
        ),
    ...
    hooks.defineLocale('mi', {
        months: 'Kohi-tate_Hui-tanguru_Poutu-te-rangi_Paenga-whawha_Haratua_Pipiri_Hongoingoi_Here-turi-koka_Mahuru_Whiringa-a-nuku_Whiringa-a-rangi_Hakihea'.split(
            '_'
        ),
        monthsShort: 'Kohi_Hui_Pou_Pae_Hara_Pipi_Hongoi_Here_Mahu_Whi-nu_Whi-ra_Haki'.split(
            '_'
        ),
    ...
    hooks.defineLocale('mt', {
        months: 'Jannar_Frar_Marzu_April_Mejju_Gunju_Lulju_Awwissu_Settembru_Ottubru_Novembru_Dicembru'.split(
            '_'
        ),
        monthsShort: 'Jan_Fra_Mar_Apr_Mej_Gun_Lul_Aww_Set_Ott_Nov_Dic'.split('_'),
        weekdays: 'Il-Hadd_It-Tnejn_It-Tlieta_L-Erbgha_Il-Hamis_Il-Gimgha_Is-Sibt'.split(
            '_'
        ),
        weekdaysShort: 'Had_Tne_Tli_Erb_Ham_Gim_Sib'.split('_'),
        weekdaysMin: 'Ha_Tn_Tl_Er_Ha_Gi_Si'.split('_'),
        longDateFormat: {
            LT: 'HH:mm',
            LTS: 'HH:mm:ss',
            L: 'DD/MM/YYYY',
        ...
        calendar: {
            ...
            nextDay: '[Ghada fil-]LT',
            nextWeek: 'dddd [fil-]LT',
            lastDay: '[Il-bierah fil-]LT',
            lastWeek: 'dddd [li ghadda] [fil-]LT',
            sameElse: 'L',
        },
        relativeTime: {
            future: 'f’ %s',
    ...
    var monthsNominative = 'styczen_luty_marzec_kwiecien_maj_czerwiec_lipiec_sierpien_wrzesien_pazdziernik_listopad_grudzien'.split(
            '_'
        ),
        monthsSubjective = 'stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrzesnia_pazdziernika_listopada_grudnia'.split(
            '_'
        );
    function plural$3(n) {
    ...
    function translate$8(number, withoutSuffix, key) {
        ...
        switch (key) {
            ...
            case 'MM':
                return result + (plural$3(number) ? 'miesiace' : 'miesiecy');
            case 'yy':
    ...
    hooks.defineLocale('pl', {
        ...
        weekdays: 'niedziela_poniedzialek_wtorek_sroda_czwartek_piatek_sobota'.split(
            '_'
        ),
        weekdaysShort: 'ndz_pon_wt_sr_czw_pt_sob'.split('_'),
    ...
    hooks.defineLocale('se', {
        months: 'oddajagemánnu_guovvamánnu_njukcamánnu_cuo?ománnu_miessemánnu_geassemánnu_suoidnemánnu_borgemánnu_cakcamánnu_golggotmánnu_skábmamánnu_juovlamánnu'.split(
            '_'
        ),
        monthsShort: 'oddj_guov_njuk_cuo_mies_geas_suoi_borg_cakc_golg_skáb_juov'.split(
            '_'
        ),
        weekdays: 'sotnabeaivi_vuossárga_ma??ebárga_gaskavahkku_duorastat_bearjadat_lávvardat'.split(
            '_'
        ),
    ...
    hooks.defineLocale('sr', {
        ...
        monthsParseExact: true,
        weekdays: 'nedelja_ponedeljak_utorak_sreda_cetvrtak_petak_subota'.split(
            '_'
        ),
        weekdaysShort: 'ned._pon._uto._sre._cet._pet._sub.'.split('_'),
        weekdaysMin: 'ne_po_ut_sr_ce_pe_su'.split('_'),
        weekdaysParseExact: true,
        longDateFormat: {
            LT: 'H:mm',
    ...
    hooks.defineLocale('tr', {
        months: 'Ocak_Subat_Mart_Nisan_Mayis_Haziran_Temmuz_Agustos_Eylül_Ekim_Kasim_Aralik'.split(
            '_'
        ),
        monthsShort: 'Oca_Sub_Mar_Nis_May_Haz_Tem_Agu_Eyl_Eki_Kas_Ara'.split('_'),
        weekdays: 'Pazar_Pazartesi_Sali_Çarsamba_Persembe_Cuma_Cumartesi'.split(
            '_'
        ),
    ...
    hooks.defineLocale('tzm-latn', {
        months: 'innayr_br?ayr?_mar?s?_ibrir_mayyw_ywnyw_ywlywz_?wšt_šwtanbir_kt?wbr?_nwwanbir_dwjnbir'.split(
            '_'
        ),
        monthsShort: 'innayr_br?ayr?_mar?s?_ibrir_mayyw_ywnyw_ywlywz_?wšt_šwtanbir_kt?wbr?_nwwanbir_dwjnbir'.split(
            '_'
        ),
    ...
    hooks.defineLocale('vi', {
        ...
        monthsParseExact: true,
        weekdays: 'ch? nh?t_th? hai_th? ba_th? tu_th? nam_th? sáu_th? b?y'.split(
            '_'
        ),
        ...
        calendar: {
            ...
            lastWeek: 'dddd [tu?n tru?c lúc] LT',
            sameElse: 'L',
        },
        relativeTime: {
            future: '%s t?i',
